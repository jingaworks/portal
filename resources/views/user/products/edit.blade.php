...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("user.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="details">{{ trans('cruds.product.fields.details') }}</label>
                <textarea class="form-control {{ $errors->has('details') ? 'is-invalid' : '' }}" name="details" id="details" required>{{ old('details', $product->details) }}</textarea>
            ...
            <div class="form-group">
                <label for="price_starts">{{ trans('cruds.product.fields.price_starts') }}</label>
                <input class="form-control {{ $errors->has('price_starts') ? 'is-invalid' : '' }}" type="number" name="price_starts" id="price_starts" value="{{ old('price_starts', $product->price_starts) }}" step="0.01">
