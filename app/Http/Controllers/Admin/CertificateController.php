...
class CertificateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.certificates.index', compact('regions', 'places', 'profiles', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.certificates.create', compact('regions', 'places', 'profiles'));
    }
    ...
    public function edit(Certificate $certificate)
    {
        ...
        return view('admin.certificates.edit', compact('regions', 'places', 'profiles', 'certificate'));
    }
