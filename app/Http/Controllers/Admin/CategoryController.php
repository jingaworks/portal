...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Category::with(['added_by'])->select(sprintf('%s.*', (new Category)->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'image', 'added_by']);
    ...
    public function show(Category $category)
    {
        ...
        $category->load('added_by', 'categorySubcategories', 'categoryProducts');
